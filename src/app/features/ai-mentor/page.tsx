        ...
        <div className="max-w-7xl mx-auto px-4 text-center relative z-10">
          ...
          >
            ...
            >
              <Button
                size="lg"
                className="bg-white text-purple-600 hover:bg-gray-100 shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300 font-semibold"
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-white/40 hover:bg-white/20 backdrop-blur-sm hover:scale-105 transition-all duration-300 !text-purple-600 hover:!text-purple-700"
