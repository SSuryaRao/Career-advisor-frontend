    ...
    <section className="relative py-20 px-4" id="cta">
      <div className="container mx-auto max-w-7xl">
        <div className="relative">
          ...
          <Card className="relative p-8 md:p-12 lg:p-16 bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl border-white/20 rounded-3xl overflow-hidden">
            {/* Decorative Elements */}
            ...
            <div className="relative z-10">
              ...
              <div className="text-center mb-12">
                <motion.div
                  ...
                  className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-500/20 to-purple-500/20 border border-white/20 rounded-full mb-6"
                >
                ...
                <motion.h2
                  ...
                  className="text-4xl md:text-6xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white via-blue-200 to-purple-200"
                >
                ...
                >
                  ...
                  <Button
                    size="lg"
                    variant="outline"
                    className="border-white/30 bg-white/10 hover:bg-white/20 text-white px-8 py-6 text-lg rounded-full backdrop-blur-xl"
                  >
                    Book Demo Call
                  </Button>
                </motion.div>
              ...
              >
                ...
                <p className="text-gray-300 mb-2">Rated 4.9/5 by 10,000+ students</p>
              ...
              >
                <div className="flex items-center justify-center gap-2 mb-3">
                  ...
                  <span className="text-orange-400 font-semibold">Early Bird Special</span>
                </div>
                ...
                <div className="flex items-center justify-center space-x-4 text-sm">
                  <span className="bg-orange-500/20 px-3 py-1 rounded-full">
                    <span className="text-orange-400 font-semibold">847 spots left</span>
                  </span>
                  <span className="text-gray-400">Expires in 48 hours</span>
                </div>
              </motion.div>
            </div>
          </Card>
